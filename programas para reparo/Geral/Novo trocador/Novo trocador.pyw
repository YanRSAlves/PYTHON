# -*- coding: cp1252 -*-
'''Esse programa foi desenvolvido por Isaias Lima dos Santos
qualquer mudança no código sinta-se à vontade, estou agradecendo
a toda força que a linguagem Python tem me oferecido, caso queiram
entrar em contato comigo por favor faça isso pelo meu site:
www.limisa.rg3.net.
        Obrigado a todos.
Espero que esse código seja bem aceito pela comunidade
Novo Trocador V2.0'''
